...
**لوحة الأدمن (`/admin`):** سجّل الدخول بـ `ADMIN_EMAIL` و`ADMIN_PASSWORD` (يُنشأ الحساب تلقائياً عند الإقلاع). تدير: الإحصاءات، العملاء، الفواتير والدفع بالتحويل، الباقات والأسعار، ومحتوى الصفحة الرئيسية.
